                        ...
                        <div className="row g-0">
                           <div className="col-lg-5 p-5 bg-success text-white">
                              ...
                              <div className="d-flex gap-4 mb-4">
                                 ...
                                 <div><h6 className="fw-bold mb-1">Văn phòng đại diện</h6><p className="small mb-0 opacity-75">TP.Cần Thơ</p></div>
                              </div>
                              <div className="d-flex gap-4 mb-4">
                                 <div className="p-3 bg-white rounded-circle flex-shrink-0 d-flex align-items-center justify-content-center" style={{ width: 54, height: 54 }}>
                              ...
                              <div className="d-flex gap-4 mb-5">
                                 ...
                                 <div><h6 className="fw-bold mb-1">Email</h6><p className="small mb-0 opacity-75">dongnguyenkh123@gmail.com</p></div>
                              </div>
